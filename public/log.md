...
# 2026-08-14
---
title: musicgrove 功能全齐 + 换框架
date: 2026-08-14
tags: [electron, wails, tauri, music, desktop]
---

一整天基本都泡在 [musicgrove](https://github.com/BlueChonk/musicgrove) 这个桌面音乐下载播放器上，从搭架子到换框架，一路折腾到打包。
...
# 2026-08-13
---
title: musicgrove 从零起步
date: 2026-08-13
tags: [electron, music, desktop, typescript]
---

从零开始造了一个 Electron 桌面版音乐播放下载器 [musicgrove](https://github.com/BlueChonk/musicgrove)。
...
title: 居住地 & 足迹地图
date: 2026-08-12
tags: [vue, map, amap, maplibre]
---

在 [homepage](https://github.com/BlueChonk/homepage) 上完成了「居住地 Residence」和「足迹 Footprints」两张地图。
...
# 2026-08-09
---
title: homepage 推倒重做 Vue 3
date: 2026-08-09
tags: [vue, vite, meta]
---

把 [homepage](https://github.com/BlueChonk/homepage) 推倒重做，这回换成 Vue 3 + Vite，组件化、路由、播放器一次到位。中途被黑屏坑了一把——`md-editor-v3` v5 早就把 `MdPreview.config` 挪成独立导出的 `config`，旧写法照抄下来，顶层 await 一炸，整个应用直接不挂载。排查半天，元凶一行代码。
...
title: 阅读 nanobot 源码
date: 2026-08-06
tags: [ai, agent, code-reading, nanobot]
---
...
title: ASR 模型推理对比
date: 2026-08-03
tags: [ai, asr, paraformer, sensevoice, benchmark]
---
...
title: 菲比 TTS 语音克隆
date: 2026-08-01
tags: [ai, tts, qwen, voice-cloning]
---
